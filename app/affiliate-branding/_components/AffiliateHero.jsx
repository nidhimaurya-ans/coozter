  ...
  return (
    <section className="container-pad pt-32 sm:pt-36 lg:pt-40">
      <div className="grid gap-12 border-y border-slate-300/80 py-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-center xl:gap-20">
        ...
        <div className="relative min-h-[420px] overflow-hidden rounded-[2rem] bg-[linear-gradient(135deg,#f8fcff,#dff3ff)] p-6 shadow-[0_28px_90px_rgba(14,62,128,0.12)] anim-blur-in anim-delay-1 md:min-h-[520px]">
          ...
          <div className="relative grid h-full place-items-center">
            <div className="grid h-32 w-32 place-items-center rounded-full bg-[linear-gradient(135deg,#071b33,#1d5edb)] text-center font-serif text-xl font-medium text-white shadow-[0_28px_80px_rgba(14,62,128,0.22)]">
              Coozter
            </div>
            {partnerNodes.map((node, index) => (
              <div
                key={node}
                className={`absolute grid h-24 w-24 place-items-center rounded-full border border-white/80 bg-white/72 text-center text-xs font-bold uppercase tracking-[0.08em] text-moss shadow-[0_18px_52px_rgba(14,62,128,0.12)] anim-fade-up anim-delay-${Math.min(index + 1, 5)} ${[
                  "left-6 top-8",
                  "right-8 top-16",
                  "left-10 bottom-16",
                  "right-12 bottom-10",
