  ...
  return (
    <AnimatedSection className="pb-20 ">
      <div className="container-pad">
        <div className="grid gap-8  border-moss/12 py-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(360px,0.6fr)] lg:items-end">
          <RevealText
            as="p"
            text="Strategy, campaigns, and reporting built for teams that want marketing to make sense again"
            className="max-w-4xl font-serif text-[2.05rem] leading-[1.08] text-ink md:text-[3.25rem] anim-slide-right"
          />
