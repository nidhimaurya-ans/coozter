...
import { sectionSpace } from "../_data/aboutContent";
...
export default function WhyChooseUsSection() {
  const { whyChoose } = useAboutPageContent();
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl text-center">
        <p className="eyebrow justify-center text-moss">{whyChoose.eyebrow}</p>
        ...
        <div className="-mx-4 mt-12 flex snap-x snap-mandatory gap-5 overflow-x-auto px-4 pb-5 text-left [scrollbar-width:none] sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 [&::-webkit-scrollbar]:hidden">
          {whyChoose.features.map(({ iconKey, title, text, details }, index) => {
            const Icon = iconMap[iconKey] || FiTarget;
